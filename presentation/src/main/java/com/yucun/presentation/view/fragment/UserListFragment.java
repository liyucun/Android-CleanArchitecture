package com.yucun.presentation.view.fragment;
...
import com.yucun.presentation.presenter.UserListPresenter;
import com.yucun.presentation.view.UserListView;
import com.yucun.presentation.view.adapter.UsersAdapter;
import com.yucun.presentation.view.adapter.UsersLayoutManager;
...
public class UserListFragment extends BaseFragment implements UserListView {
  ...
  @Override public void renderUserList(Collection<UserEntity> userModelCollection) {
    if (userModelCollection != null) {
      this.usersAdapter.setUsersCollection(userModelCollection);
    }
  }

  @Override public void viewUser(UserEntity userEntity) {
    if (this.userListListener != null) {
      this.userListListener.onUserClicked(userEntity);
    }
  }
  ...
  private UsersAdapter.OnItemClickListener onItemClickListener =
      new UsersAdapter.OnItemClickListener() {
        @Override public void onUserItemClicked(UserEntity userEntity) {
          if (UserListFragment.this.userListPresenter != null && userEntity != null) {
            UserListFragment.this.userListPresenter.onUserClicked(userEntity);
          }
        }
      };
}
